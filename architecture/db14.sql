...
CREATE TABLE `contract` (
  ...
  `complainDetail` text COLLATE utf8mb4_bin,
  `costPerHour` bigint(20) NOT NULL,
  `resolveDetail` text COLLATE utf8mb4_bin,
...
INSERT INTO `contract` VALUES (1,20,0,NULL,3333333333,'Mỗi ngày 2 tiếng, 1 tuần ít nhất 3 buổi','inProgress',-1,' ',1,1,'student1',NULL,0,NULL);
...
-- Dump completed on 2020-01-07  6:08:04
